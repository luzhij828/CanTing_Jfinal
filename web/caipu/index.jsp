					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<small><a href="${path}/caipu/add">菜谱增加</a></small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a href="${path}/caipu/edit/${row.id}">${row.title}</a>
														</td>
														<td>${row.creator}</td>
														<td class="hidden-480">${row.summary}</td>
													...
													<script>
													function edit(domid){
														location.href="${path}/caipu/edit/"+domid;
														
													}
													function del(domid){
														if(confirm("确定删除吗?")){
															location.href="${path}/caipu/delete/"+domid;
														}
													}
													</script>
												</tbody>
								...
								<c:set var="actionUrl" value="${path}/caipu/" />
